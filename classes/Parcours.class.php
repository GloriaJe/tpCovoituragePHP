...
class Parcours{
	...
	public function affecte($donnees){
		foreach ($donnees as $attribut => $valeur){
			switch($attribut){
				...
				case 'par_km' : $this->setPar_km($valeur);
				break;

				case 'vil_num1' : $this->setVil_num1($valeur);
				break;

				case 'vil_num2' : $this->setVil_num2($valeur);
				break;
			}
		}
	}
	...
	public function setVil_num1($vil_num){
		//controle des valeurs
		$this->vil_num1 = $vil_num;
	}
	...
	public function setVil_num2($vil_num){
		//controle des valeurs
		$this->vil_num2 = $vil_num;
	}
